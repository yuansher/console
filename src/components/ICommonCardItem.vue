      ...
      <div class="common-card-item-box" v-for="(item,index) in listData" :key="index">
        ...
        <template v-for="alertItem in propData.alertOptionList">
          <div class="common-card-item-tip" v-if="
                  ...
                  " :key="alertItem.key">
            <a-alert :message="alertItem.alertText" :show-icon="alertItem.showIcon" :closable="alertItem.showCloseButton" :type="alertItem.alertType" />
          </div>
        </template>
          ...
          switch (key) {
            ...
            case "bgColor":
              if(element&&element.hex8){
                ...
                window.IDM.setStyleToPageHead("."+this.moduleObject.id +"-ddbox .ant-dropdown-menu",{"background-color":element.hex8});
              }
              break;
            case "hoverBgColor":
              if(element&&element.hex8){
                window.IDM.setStyleToPageHead("."+this.moduleObject.id +"-ddbox .ant-dropdown-menu-item:hover,."+this.moduleObject.id +"-ddbox .ant-dropdown-menu-submenu-title:hover",{"background-color":element.hex8});
              }
              break;
            case "box":
            ...
            case "subFont":
              ...
              window.IDM.setStyleToPageHead(this.moduleObject.id +" .common-card-item-box .cc-item-info-subtitle",styleObject1);
              break;
          }
        }
      }
