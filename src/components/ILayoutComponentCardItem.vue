  ...
  <div idm-ctrl="idm_module" :id="moduleObject.id" :idm-ctrl-id="moduleObject.id">
    ...
    <div class="layout-component-card-item-outbox">
      <div class="layout-component-card-item-box" v-if="propData.showNewItemCard" @click="itemClickHandle(null,'newClickCustomFunction')">
        ...
        <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M426.666667 426.666667H85.546667A85.418667 85.418667 0 0 0 0 512c0 47.445333 38.314667 85.333333 85.546667 85.333333H426.666667v341.12c0 47.274667 38.186667 85.546667 85.333333 85.546667 47.445333 0 85.333333-38.314667 85.333333-85.546667V597.333333h341.12A85.418667 85.418667 0 0 0 1024 512c0-47.445333-38.314667-85.333333-85.546667-85.333333H597.333333V85.546667A85.418667 85.418667 0 0 0 512 0c-47.445333 0-85.333333 38.314667-85.333333 85.546667V426.666667z"></path></svg>
      ...
      <div class="layout-component-card-item-box" @click="itemClickHandle(item)" v-for="(item,index) in listData" :key="index">
        ...
        <div class="cc-item-grid-count-box">
          <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3289"><path d="M448 563.2a12.8 12.8 0 0 1 12.5952 10.496l0.2048 2.304v358.4a12.8 12.8 0 0 1-10.496 12.5952L448 947.2h-358.4a12.8 12.8 0 0 1-12.5952-10.496L76.8 934.4v-358.4a12.8 12.8 0 0 1 10.496-12.5952L89.6 563.2h358.4z m486.4 0a12.8 12.8 0 0 1 12.5952 10.496l0.2048 2.304v358.4a12.8 12.8 0 0 1-10.496 12.5952L934.4 947.2h-358.4a12.8 12.8 0 0 1-12.5952-10.496L563.2 934.4v-358.4a12.8 12.8 0 0 1 10.496-12.5952L576 563.2h358.4zM358.4 665.6H179.2v179.2h179.2v-179.2z m486.4 0h-179.2v179.2h179.2v-179.2zM448 76.8a12.8 12.8 0 0 1 12.5952 10.496L460.8 89.6v358.4a12.8 12.8 0 0 1-10.496 12.5952L448 460.8h-358.4a12.8 12.8 0 0 1-12.5952-10.496L76.8 448v-358.4a12.8 12.8 0 0 1 10.496-12.5952L89.6 76.8h358.4z m486.4 0a12.8 12.8 0 0 1 12.5952 10.496L947.2 89.6v358.4a12.8 12.8 0 0 1-10.496 12.5952L934.4 460.8h-358.4a12.8 12.8 0 0 1-12.5952-10.496L563.2 448v-358.4a12.8 12.8 0 0 1 10.496-12.5952L576 76.8h358.4zM358.4 179.2H179.2v179.2h179.2V179.2z m486.4 0h-179.2v179.2h179.2V179.2z"></path></svg>
    ...
    <a-modal
      :title="'【'+CurrentModuleObject.title+'】效果图预览'"
      :visible="visible"
      cancelText="关闭"
      okText=""
      width="848px"
...
.layout-component-card-item-box{
  ...
  .cc-item-img-count-box,.cc-item-grid-count-box{
    position: absolute;
    background-color: rgba(0,0,0,0.25);
    color: white;
    height: 24px;
